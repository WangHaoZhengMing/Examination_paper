...
+ 若P、V操作的信号量 S 初值为 2, 当前值为 -1, 则表示有 #uline(answer: "1") 个等待进程。
...
+ 已知某分页系统主存容量为 64k，页面大小 2k，对一个 4 页大的作业，第 0、1、2、3 页被分配到内存的 2、4、6、7 块中。将十进制逻辑地址 2600 转换成物理地址是 #uline(answer: "8744") 。
= 解答题答案
